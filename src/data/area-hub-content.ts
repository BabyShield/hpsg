...
export const areaHubContent: Record<string, AreaHubContent> = {
  hampstead: {
    ...
    typical:
      "The usual instruction is a kitchen or bathroom in a conversion, whole-flat decoration, or joinery repairs on original sashes, with village-lane access and conservation-area extract treated as part of the survey rather than as a surprise on site. Lime plaster, original joinery and floors that have moved are ordinary finds. The property is often occupied, or a conversion where the common parts are as sensitive as the rooms themselves.",
    working:
  ...
  "west-hampstead": {
    ...
    typical:
      "The usual instruction is a light refurbishment of a conversion flat, a kitchen in a rear return, or occupied-home decorating. Party-wall noise in terraces and stacked bathrooms on half-landings belong in the programme from the start. Loading is planned on the residential streets toward Fortune Green and South Hampstead, not on West End Lane.",
    working:
  ...
  "belsize-park": {
    ...
    typical:
      "The usual instruction is an ensuite in a conversion, a kitchen laid out around chimney breasts, or decoration of high-ceilinged principal rooms. Extract and drainage come first, because kitchens and bathrooms have often been inserted into former bedrooms or service rooms. Stucco repair and conservation-area assumptions stay on until the map says otherwise.",
    working:
  ...
  "st-johns-wood": {
    ...
    typical:
      "The usual instruction is a kitchen or bathroom in a mansion flat, with drawings a managing agent will actually accept, or decoration of a villa's principal rooms. Licence-to-alter packs are ordinary here, not exceptional. Carcasses often go up the stairs, because the lifts in those blocks are not large enough.",
    working:
  ...
  "maida-vale": {
    ...
    typical:
      "The usual instruction is a compact kitchen re-fit in a rear room, bathroom tanking over a timber intermediate floor, or whole-flat light refurbishment. Layout follows the original stacks and ducts rather than a showroom plan. Material goes up the stairs more often than in a lift, and porters have views about when a skip may appear.",
    working:
  ...
  "swiss-cottage": {
    ...
    typical:
      "The usual instruction is a mansion-block kitchen or bathroom, or decoration of a conversion a street back from Finchley Road. Ceiling heights and window sizes change between the Victorian houses toward Belsize and Frognal and the later blocks on Avenue Road. Agent coordination is part of the method in the larger buildings.",
    working:
  ...
  "primrose-hill": {
    ...
    typical:
      "The usual instruction is family-house decoration, a kitchen in a lower-ground room, or a bathroom in a split house where the drainage run is long. Damp and extract in those lower-ground kitchens have to be solved properly rather than painted over. Weekend visitors around the park are an access issue, not a marketing line.",
    working:
  ...
  highgate: {
    ...
    typical:
      "The usual instruction is decoration of original interiors, a kitchen in a villa or conversion, or a bathroom where the stack is a long run from the proposed ensuite. The first fact to settle is which council the address sits in — Camden, Haringey, or, on some streets, Islington. Steep roads, woods and tree protection affect access even when the work is internal.",
    working:
  ...
  "golders-green": {
    ...
    typical:
      "The usual instruction is a family-house kitchen, a bathroom replacement, or whole-house decoration. Plots are larger than Camden conversions, and kitchens are more often original family rooms than inserted closets. Off-street parking is more common, which changes how materials arrive.",
    working:
  ...
  "queens-park": {
    ...
    typical:
      "The usual instruction is a terrace kitchen and bathroom, a light refurbishment of a conversion, or decoration that respects original joinery in the Estate cottages. The address tells us whether we are writing to Brent or Westminster. Two councils mean two licensing regimes for the same neighbourhood name.",
    working:
  ...
  "muswell-hill": {
    ...
    typical:
      "The usual instruction is a family-house kitchen or bathroom, whole-house decoration, or a conversion flat above and behind the Broadway. The work is family-house work more often than mansion-block work, which is the reverse of Maida Vale. Material handling on the steep streets is planned rather than assumed.",
    working:
  ...
  "crouch-end": {
    ...
    typical:
      "The usual instruction is a light refurbishment of a converted house, a kitchen in a rear room, or occupied decorating, with the original hall and joinery kept where they are sound. Purpose-built blocks are the exception. The Broadway is a poor place to leave a skip; side streets take the loading.",
    working:
  ...
  "kentish-town": {
    ...
    typical:
      "The usual instruction is a conversion kitchen or bathroom, whole-flat decoration, or joinery repairs. Kitchens sit in rear returns or lower-ground rooms that need damp and extract solved properly. Toward Tufnell Park and Dartmouth Park the streets become more residential and more likely to include original family houses.",
    working:
  ...
  kilburn: {
    ...
    typical:
      "The usual instruction is a light refurbishment of a conversion flat, a kitchen and bathroom swap, or decoration. East toward West Hampstead the streets are more uniformly Victorian conversions; west, the mix is wider. Flats above shops need a method statement for access and extract, and the High Road is not treated as a default skip site.",
    working:
  ...
  "hampstead-garden-suburb": {
    ...
    typical:
      "The usual instruction is internal: a kitchen, bathroom, decoration or flooring that does not change the street elevation. Permitted development is not the working assumption. External work sits under Barnet planning and, where the Scheme of Management applies, separate Trust consent.",
    working:
  ...
  "hampstead-heath": {
    ...
    typical:
      "The usual instruction is family-house decoration, kitchen or bathroom replacement, with extract planned so it does not land on a Heath-facing elevation as a convenience. Gardens, levels and trees do as much to shape a project as the plan of the house. Vale of Health lanes need the right vehicle and timing.",
    working:
  ...
  "regents-park": {
    ...
    typical:
      "The usual instruction, where we take it, is internal kitchen, bathroom and decoration within an existing demise. Facade and carcass work is not the service. Many flats are listed or highly controlled, with original plans, shared services and freeholders — including, on some buildings, the Crown Estate — who run a tight approval process.",
    working:
  ...
  archway: {
    ...
    typical:
      "The usual instruction is a conversion kitchen or bathroom, decoration, or light refurbishment of a flat on the residential streets. Converted houses on the high ground are closer to the rest of our North West London stock; gyratory-side buildings are a different construction and tenure mix. Loading is planned on side streets, not on the gyratory.",
    working:
  ...
  frognal: {
    ...
    typical:
      "The usual instruction is a kitchen in a converted house, a bathroom, or decoration of large rooms. The houses are bigger-boned than West Hampstead terraces — wider halls, larger rooms, more original joinery. The gradient affects material handling; the Finchley Road end has different highway rules from the Village end.",
    working:
  ...
  "temple-fortune": {
    ...
    typical:
      "The usual instruction is a family-house kitchen or bathroom, decoration, or flat refurbishment above the parade. The first check is whether the address sits inside the Suburb Trust and conservation-area boundary or under ordinary Barnet planning. Extract on flats above shops is a usual constraint.",
    working:
  ...
  "dartmouth-park": {
    ...
    typical:
      "The usual instruction is family-house decoration, a kitchen replacement, or a bathroom in a conversion. The streets are wider than Kentish Town proper, with more original family houses and a conservation-area grain. Skip placement still needs a Camden licence and neighbour notice.",
    working:
  ...
  "tufnell-park": {
    ...
    typical:
      "The usual instruction is a conversion kitchen or bathroom, light refurbishment, or occupied decorating. Bathrooms are often a half-landing or rear-return room, with a long run to the stack; layout follows the drainage. The address names the council — Islington or Camden — before any licence is applied for.",
    working:
  ...
  "east-finchley": {
    ...
    typical:
      "The usual instruction is a family-house kitchen, bathroom or decoration. Kitchens are typically family-sized rather than mansion-block compact. Proximity to Hampstead Garden Suburb does not bring a property under the Trust; High Road loading is the main constraint on the commercial spine.",
    working:
  ...
  "kensal-rise": {
    ...
    typical:
      "The usual instruction is a kitchen and bathroom replacement in a terrace, light refurbishment of a conversion, or decoration. The stock is close in type to Queen's Park — bay-fronted terraces, original joinery, modest rear gardens — without being the same neighbourhood. Chamberlayne Road is a tight commercial spine, and Overground-station parking pressure belongs in the loading plan.",
    working:
  ...
  "south-hampstead": {
    ...
    typical:
      "The usual instruction is a mansion-block or conversion kitchen and bathroom, decoration, or light refurbishment. The streets around Netherhall and Belsize Road mix stucco and brick; toward the railway the grain is tighter. Managing-agent hours and licence-to-alter processes apply in the purpose-built stock.",
    working:
