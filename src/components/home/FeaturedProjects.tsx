      ...
      <Container>
        <div className="flex flex-col items-start justify-between gap-10 lg:flex-row lg:items-end">
          <div className="max-w-2xl">
            ...
            <h2 className="font-display text-4xl font-normal sm:text-5xl">Typical work</h2>
        ...
        <ul className="mosaic mt-16 grid-cols-1 lg:grid-cols-12">
          {featured.map((service, index) => (
            <li
              key={service.slug}
              className={
                index === 0
                  ? "min-h-[22rem] lg:col-span-8 lg:row-span-2 lg:min-h-[38rem]"
                  : "min-h-[16rem] lg:col-span-4 lg:min-h-[18.9rem]"
              }
            >
              <ServiceCard
                service={service}
